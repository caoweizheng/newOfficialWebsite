 ...
 * @Last Modified time: 2018-07-04 11:47:40
...
export const menuDS = [
  {
    src: `${images}/icon-bt${Const.__IMG_DPR__}.png`,
    label: '本汀官网',
    href: '/'
  },
  {
    src: `${images}/icon-invite${Const.__IMG_DPR__}.png`,
    label: '同城约钓'
  },
  {
    src: `${images}/icon-point${Const.__IMG_DPR__}.png`,
    label: '积分中心',
    href: 'https://www.nidosport.com/event/integral'
  },
  {
  ...
  {
    src: `${images}/icon-coupon${Const.__IMG_DPR__}.png`,
    label: '社区福利',
    href: 'https://www.nidosport.com/event/get_coupon'
  },
  {
    src: `${images}/icon-gift${Const.__IMG_DPR__}.png`,
    label: '粉丝福利',
    href: 'https://www.nidosport.com/event'
  },
  {
    src: `${images}/icon-cash${Const.__IMG_DPR__}.png`,
    label: '现金福利',
    href: 'https://www.tw-bt.com/shop/coupon'
  },
  {
    src: `${images}/icon-nearby${Const.__IMG_DPR__}.png`,
    label: '附近',
    href: 'https://www.tw-bt.com/merchant'
  }
];
