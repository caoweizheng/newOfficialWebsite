 ...
 * @Last Modified time: 2018-07-19 11:37:46
...
import { getMonth, images } from './ds';
  ...
  return (
    <div className={classNames(prefixCls, className)}>
      <Flex justify="between" align="center">
        <p className="month t-34">{getMonth(m)}月</p>
      </Flex>
      <Flex
        className="mt-24"
        justify="around"
            ...
            return (
              <Flex.Item className="ml-0" key={item.d}>
                <span className="sign-day">
                  <i
                    className={classNames('day-num t-34 l-48', {
                  ...
                  >
                    {index >= 6 ? (
                      <Img
                        size="0.45rem"
                        transparent
                        src={`${images}/gift${Const.__IMG_DPR__}.png`}
                        alt=""
                      />
                    ) : (
                      `${item.d}`
