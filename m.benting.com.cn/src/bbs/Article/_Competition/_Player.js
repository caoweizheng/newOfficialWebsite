 ...
 * @Last Modified time: 2018-07-17 09:57:21
        ...
        <List>
          {competitionPlayers.map((item, index) => (
            <List.Item
              key={item.id}
              wrap
              thumb={<Img src={item.avatar} circle />}
            >
              <Flex>
                <Flex.Item>
                  <Flex>
                    ...
                    />
                    <span className="t-30 l-44 ml-xs">{item.name}</span>
                  </Flex>
                  <p className="t-24 l-36 t-sub">{item.description}</p>
                </Flex.Item>
                <div
