/**
 * const prefixCls = 'style-171234';
 * const images = '/static/images/src/bbs/Article';
 * @Author: czy0729
 * @Date: 2018-07-13 18:00:43
 * @Last Modified by: czy0729
 * @Last Modified time: 2018-07-18 09:13:49
 * @Path m.benting.com.cn /src/bbs/Article/_Registration.js
 */
...
const _Registration = (props, { $ }) => {
  ...
  return (
    <div className={classNames(prefixCls, className)}>
      <Button type={type} onClick={() => Utils.checkLogin(onClick)}>
        {text}
      </Button>
