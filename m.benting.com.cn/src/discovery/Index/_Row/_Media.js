 ...
 * @Last Modified time: 2018-07-09 11:44:21
      ...
      <div className="mt-d">
        ...
        >
          <img
            ...
            src={redImg}
            onClick={() =>
              Utils.checkLogin(() => $.doRedClick(packetId, redType, infoId))
            }
            alt=""
          />
          {isUserPublish ? (
            ...
            <span className="p-red-text t-b">{redTypeText || ext}红包</span>
          )}
        </div>
        ...
        {renderImgView && (
          <ImgView
            ...
            data={dataImgView.map(item => {
              ...
              return Utils.getAppImgUrl(item.filePath, 'scale');
            })}
            onClose={() =>
              this.setState({
                renderImgView: false,
