 ...
 * @Last Modified time: 2018-07-18 10:02:07
  ...
  return (
    <div className={classNames(prefixCls, className)}>
      <Header
        title="鱼获有豪礼"
        desc="使用本汀产品钓鱼送大礼！"
        href="https://www.nidosport.com/discovery/fish_category"
      />
        ...
        {fish.list.map(item => {
          ...
          return (
            ...
            >
              ...
              <div className="info">
                <span className="t-56 l-80 t-danger t-b ls-1">
                  {item.rate}
                </span>
