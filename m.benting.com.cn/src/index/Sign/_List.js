 ...
 * @Last Modified time: 2018-07-19 11:28:34
...
const Rank = props => {
  ...
  return (
    ...
    >
      ...
      <span className="t-primary t-30 l-44">+{poin}积分</span>
    </Flex>
  );
};
...
const List = (props, { $ }) => {
  ...
  return (
    <div className={classNames(prefixCls, className)}>
      <div style={{ background: Styles.color_theme }}>
          ...
          {list.length > 0 &&
            list.filter((item, index) => index >= 3).map((item, index) => (
              ...
              >
                ...
                <span className="t-primary t-30 l-44 t-m">+15积分</span>
              </Flex>
            ))}
        </div>
      </div>
